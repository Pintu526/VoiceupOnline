...
- Campaign admin can add missing district, block/tehsil/taluk, and gram panchayat/ward values inline beside each dropdown with a `+` action; duplicates are blocked and new values appear in the public signing page
